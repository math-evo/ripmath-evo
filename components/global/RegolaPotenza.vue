<template>
  ...
  <v-card color="grey lighten-2" flat>
    ...
    <v-card-text>
      <p>il prodotto di due potenze con la stessa base e' una potenza che ha per base la stessa base e per esponente la somma degli esponenti.</p>
      <p>
        ...
        <v-dialog>
          ...
          <v-card>
            <v-card-title>
              <katex class="red--text" display-mode>a^r \cdot a^s = a^{r + s}</katex>
            </v-card-title>
            <v-card-text>
              <p>Questa e' la regola in linguaggio "matematico" per fare la traduzione devi seguire questa procedura:</p>
              <p>
              ...
              <p>
                ...
                <span class="indigo--text">
                  REGOLA: il prodotto fra due potenze aventi la stessa base e'
                  uguale a una potenza avente per base la stessa base e per
