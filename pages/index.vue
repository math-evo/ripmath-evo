  ...
  >
    ...
    >
      <v-card>
        ...
        <v-card-text>
          <p>
            Questo sito e' dedicato a chi ha qualche difficolta' con la matematica: la matematica
            non deve complicarci la vita ma aiutarci a viverla meglio.
            Se hai qualche difficolta' significa che nella tua carriera scolastica
            hai recepito qualcosa in modo sbagliato oppure lacunoso;
            spero che questo sito ti aiuti a capire dove sbagli ed a superare le tue difficolta'
          </p>
        </v-card-text>
      </v-card>
      <v-card>
        ...
        <v-card-text>
          <em>
            Se pensi che la difficolta' in matematica non sia dovuta al poco impegno ti consiglio di visitare il sito
            <a
              href="http://www.mateditutti.it"
              target="_blank"
            >www.mateditutti.it</a>
            dove potrai trovare un grosso aiuto
          </em>
        </v-card-text>
      </v-card>
      <v-card>
        ...
        <v-card-text>
          ...
          <p>
            Ma se io ti dico <katex>2\log 5 +3\log 5</katex> cosa scrivi? evidentemente <katex>5\log 5</katex> perche' anche queste sono 2 cose uguali piu' altre 3 cose uguali allora <katex>\log 5</katex> e' quello che io chiamo sovrastruttura; e guarda che posso renderla complicata quanto voglio.
          </p>
          <p>
            <katex>
